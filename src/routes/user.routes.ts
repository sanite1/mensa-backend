...
router.put('/me/addresses/:id', validateUpdateAddress, controller.updateMyAddress)
router.put('/me/addresses/:id/default', validateAddressIdParam, controller.setDefaultMyAddress)
router.delete('/me/addresses/:id', validateAddressIdParam, controller.deleteMyAddress)
